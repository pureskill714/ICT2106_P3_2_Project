...
export default class ServiceCenterResourceRequestList extends React.Component {
  state = {
    content: null,
    headers: [],
    loading: true,
  ...
  settings = {
    title: "Service Center Resource Request List",
    primaryColor: "#a6192e",
    accentColor: "#94795d",
    textColor: "#ffffff",
  ...
  render() {
    if (this.state.loading) {
      ...
      return (
        ...
        <div>
          <p>ServiceCenterResourceRequestList</p>
        </div>
      );
    }
  }
